package com.mycode.jxzlpj.jiaoxuesheji.kcjxssfa.controller;
...
import com.mycode.jxzlpj.jiaoxuesheji.kcjxssfa.service.KcjxssfaService;
...
public class KcjxssfaController {
    ...
    public JsonResult<Object> getItemList(@RequestParam("relationCode") String relationCode){
        List<KcjxssfaItem> itemList = kcjxssfaService.getItemList(relationCode);
