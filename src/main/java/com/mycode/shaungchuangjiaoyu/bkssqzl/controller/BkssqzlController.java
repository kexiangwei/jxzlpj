package com.mycode.shaungchuangjiaoyu.bkssqzl.controller;
...
public class BkssqzlController {
    ...
    public JsonResult<Object> getPageList(Bkssqzl obj){
        Map<String, Object> resultMap = bkssqzlService.getPageList(obj);
        return JsonResult.success(resultMap);
    }

    @ResponseBody
    @RequestMapping("/insert.do")
    public JsonResult<Object> insert(Bkssqzl obj){
        boolean bool = bkssqzlService.insert(obj);
        if(!bool){
    ...
    public JsonResult<Object> update(Bkssqzl obj){
        boolean bool = bkssqzlService.update(obj);
        if(!bool){
    ...
    public JsonResult<Object> delete(@RequestParam("objCode") String objCode){
        boolean bool = bkssqzlService.delete(objCode);
        if(!bool){
    ...
    public JsonResult<Object> toSubimt(@RequestParam("menuId") Integer menuId,@RequestParam("jsonStr") String jsonStr){
        ...
        List<Bkssqzl> objList = JSON.parseArray(jsonStr, Bkssqzl.class);
        boolean bool = bkssqzlService.toSubimt(activeShenheCode,objList);
        if(!bool){
    ...
    public JsonResult<Object> toShenhe(ShenHeItem item,@RequestParam("jsonStr") String jsonStr){
        List<Bkssqzl> objList = JSON.parseArray(jsonStr, Bkssqzl.class);
        boolean bool = bkssqzlService.toShenhe(item,objList);
        if(!bool){
